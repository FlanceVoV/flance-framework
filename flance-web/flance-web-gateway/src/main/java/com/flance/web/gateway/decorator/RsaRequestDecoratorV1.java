...
public class RsaRequestDecoratorV1 extends ServerHttpRequestDecorator {
    ...
    public RsaRequestDecoratorV1(ServerHttpRequest delegate, String logId, CachedBodyOutputMessage outputMessage) {
        super(delegate);
        this.logId = logId;
